...
const buttonStyle = tva({
  base: "group/button flex-row items-center justify-center gap-2 rounded-lg bg-primary-500 data-[focus-visible=true]:web:outline-none data-[focus-visible=true]:web:ring-2 data-[disabled=true]:opacity-40",
  variants: {
    action: {
      primary:
